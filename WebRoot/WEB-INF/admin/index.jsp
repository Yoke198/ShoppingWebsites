	 ...
	 var _menus = {"menus":[
						{"menuid":"1","icon":"icon-sys","menuname":"控件使用",
							"menus":[
									...
									{"menuid":"13","menuname":"用户管理","icon":"icon-users","url":"users.html"},
									{"menuid":"14","menuname":"角色管理","icon":"icon-role","url" : "role.html"},
									{"menuid":"15","menuname":"权限设置","icon":"icon-set","url":"power.html"},
...
<div style=" position:absolute; z-index:100000; height:2046px;top:0px;left:0px; width:100%; background:white; text-align:center;">
    ...
    <div region="north" split="true" border="false" style="overflow: hidden; height: 30px;
        ...
        <span style="padding-left:10px; font-size: 16px; "><img src="images/blocks.gif" width="20" height="20" align="absmiddle" />一元购</span>
    </div>
